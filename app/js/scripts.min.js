  ...
  $.fn.onepage_scroll = function(options){
    ...
    $.fn.moveDown = function() {
      ...
      if(settings.pagination == true) {
        $(".onepage-pagination li a, nav.desktop li a" + "[data-index='" + index + "']").removeClass("active");
        $(".onepage-pagination li a, nav.desktop li a" + "[data-index='" + next.data("index") + "']").addClass("active");
      }
    ...
    $.fn.moveTo = function(page_index) {
      ...
      if(next.length > 0) {
        ...
        current.removeClass("active")
        next.addClass("active")
        $(".onepage-pagination li a, nav.desktop li a" + ".active").removeClass("active");
        $(".onepage-pagination li a, nav.desktop li a" + "[data-index='" + (page_index) + "']").addClass("active");
        $("body")[0].className = $("body")[0].className.replace(/\bviewing-page-\d.*?\b/g, '');
        $("body").addClass("viewing-page-"+next.data("index"))
    ...
    $.each( sections, function(i) {
      ...
      if(settings.pagination == true) {
        ...
        menuList += "<li><a data-index='"+(i+1)+"' href='#" + (i+1) + "'></a></li>"
      }
    });

    //$("nav.desktop ul").html(menuList);
    ...
    if(window.location.hash != "" && window.location.hash != "#1") {
      ...
      if (parseInt(init_index) <= total && parseInt(init_index) > 0) {
        ...
        if(settings.pagination == true) $(".onepage-pagination li a, nav.desktop li a" + "[data-index='" + init_index + "']").addClass("active");
        ...
        if(settings.pagination == true) $(".onepage-pagination li a, nav.desktop li a" + "[data-index='1']").addClass("active");
      }
    }else{
      $(settings.sectionContainer + "[data-index='1']").addClass("active")
      $("body").addClass("viewing-page-1")
